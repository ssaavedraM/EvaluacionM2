# Evaluación Módulo 2 : Desarrollo Final del Sitio Web del Hospital
***Equipo: LORENA SOTO, EDWIN MAUREIRA, SERGIO SAAVEDRA***

## Descripción

El siguiente proyecto muestra el entregable correspondiente a la evaluación del Módulo 2, que considera una serie de iteraciones enfocadas en desarrollar y mejorar el sitio web de un hospital privado. 
Dentro de lo aplicado en el proyecto para la entrega final se tiene:
- Establecimiento de estructuras semánticas del sitio web para la creación de las páginas principales **Home**, **Equipo Médico** y **Contacto**.
- Modularización de estilos y aplicación de **metodología BEM**.
- Uso de **Media Queries** para adaptabilidad de la página a distintos tamaños de pantalla.
- Integración de **preprocesador SASS**.
- Integración de **Bootstrap** y sobrescritura de variables.

_El proyecto escogido para mejorar corresponde al de Sergio Saavedra_
